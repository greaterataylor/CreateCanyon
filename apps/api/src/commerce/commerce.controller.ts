import { Body, Controller, Delete, Get, Headers, Param, Post, Query, type RawBodyRequest, Req } from "@nestjs/common";
...
export class CommerceController {
  ...
  public resume(@CurrentPrincipal() principal:Principal,@Param("orderId") orderId:string){return this.commerce.resume(principal,orderId);}
